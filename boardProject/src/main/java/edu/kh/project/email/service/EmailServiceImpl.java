...
// @RequiredArgsConstructor == final 필드에 Bean 의존성 주입 한 번에 하기
...
public class EmailServiceImpl implements EmailService{
	...
	public int sendEmail(String htmlName, String email) {
		...
		try {
			...
			// HTML 코드 전체가 하나의 String 으로 변환되서 반환받은 후
  ...
  public String createAuthKey() {
	...
	public String loadHtml(String authKey, String htmlName) {
		...
		// context 를 import 할 때 org.tyhmeleaf.Context 선택!!
...
//	
//	@Autowired
//	public void set필드명(자료형 변수명) { // Autowired 가 변수명에 들어가고 변수명이 필드명에 들어감
//		this.필드명 = 변수명;
//	}
...
//	private 자료형 필드명2;
//	
//	@Autowired																				 // 의존성 주입(Autowired)를 변수명 1,2 에 같이 받고
//	public 클래스명(자료형 변수명1, 자료형 변수명2) {  // 필드명 1,2에 각각 대입
//		this.필드명1 = 변수명 1;
//		this.필드명2 = 변수명 2;
//	}