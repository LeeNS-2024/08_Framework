...
//	  @SessionAttributes에 의해서 session에 등록된 값을 
// 		얻어올 수 있음
...
public class MyPageController {
	 ...
	 * @param ra					: 리다이렉트 시 request scope로 값 전달 (한 번만 전달하고 싶은 값 있을때 사용하면 좋음)
	 * @return
	 */
	@PostMapping("info")
	public String updateInfo(
		@ModelAttribute Member inputMember,
		@SessionAttribute("loginMember") Member loginMember, // session에서 가져온 값 (바꾸면 세션값도 바뀜)
		...
		// 4. 수정 성공 시 session에 저장된 로그인 회원 정보를
