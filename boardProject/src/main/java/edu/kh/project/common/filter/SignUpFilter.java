...
public class SignUpFilter implements Filter{
	...
	public void doFilter(
			ServletRequest request,    // HttpServletRequest 의 부모 타입
		...
		// HTTP 통신이 가능한 형태로 request, reponse 다운 캐스팅
		...
		if(session.getAttribute("loginMember") != null) { // 로그인이 되어 있는 경우
			...
			// 다음 필터로 이동
			// (만약 다음 필터가 없다면 Dispatcher Servlet으로 이동)
