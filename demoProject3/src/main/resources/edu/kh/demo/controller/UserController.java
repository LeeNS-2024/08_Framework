...
public class UserController {
	...
	public String selectUser(
			...
			ra.addFlashAttribute("messageq","사용자가 존재하지 않습니다");
	...
	public String insertUser(
		...
		int result = service.insertUser(user);
				...
				// 추가 여부에 따라 redirect 경로, 메시지 지정하기
				String path = null;
				String message = null;
				
				if(result > 0) {
					path = "redirect:/user/selectAll"; // 목록
					message = user.getUserName() + "님이 추가 되었습니다";
				}else {
					path = "redirect:/user/insert"; // 상세
					message ="추가 실패";
				}
