...
public class MainController {
    ...
    // -> charset=UTF-8 을 추가하여 응답 데이터의 문자 인코딩을 UTF-8로 지정
    //  --> 한글 깨짐 해결
...
//			model.addAttribute("item", items.get(0));
	...
	*/
	...
	public String airPollution(
			@RequestParam("cityName") String cityName) throws IOException,URISyntaxException{
		
	// API 개인 인증키
	String serviceKey 
		= "9I%2FHKLl0GKv3kXS37IHOELfhrqEwepLi%2F1wvyGl0s6mNqB2ANthxA1uNblvXweyvT2T%2BzdnFAeTzue3WRDnzNQ%3D%3D";
